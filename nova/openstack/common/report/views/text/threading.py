...
class StackTraceView(jv.JinjaView):
    ...
    :class:`nova.openstack.common.report.models.threading.StackTraceModel`
    """
...
class GreenThreadView(object):
    ...
    model :class:`nova.openstack.common.report.models.threading.GreenThreadModel`  # noqa
    """
...
class ThreadView(object):
    ...
    model :class:`nova.openstack.common.report.models.threading.ThreadModel`  # noqa
    """
