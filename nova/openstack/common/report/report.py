...
class BasicReport(object):
    ...
    def add_section(self, view, generator, index=None):
        ...
        returns a :class:`nova.openstack.common.report.models.base.ReportModel`
        or similar object.
...
class ReportOfType(BasicReport):
    ...
    .. seealso::
       ...
       Class :class:`nova.openstack.common.report.models.with_default_view.ModelWithDefaultView` # noqa
          (the entire class)

       Class :class:`nova.openstack.common.report.models.base.ReportModel`
           :func:`nova.openstack.common.report.models.base.ReportModel.set_current_view_type` # noqa
...
class TextReport(ReportOfType):
    ...
    def add_section(self, heading, generator, index=None):
        ...
        :class:`nova.openstack.common.report.views.text.header.TitledView`
