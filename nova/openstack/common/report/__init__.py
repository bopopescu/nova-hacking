...
report ( :class:`nova.openstack.common.report.report.BasicReport` )
is composed of one or more report sections
( :class:`nova.openstack.common.report.report.BasicSection` ),
which contain generators which generate data models
( :class:`nova.openstack.common.report.models.base.ReportModels` ),
