...
:mod:`nova.openstack.common.report.models.threading`.
"""
...
class ThreadReportGenerator(object):
    ...
    :class:`nova.openstack.common.report.models.threading.ThreadModel`
...
class GreenThreadReportGenerator(object):
    ...
    This generator returns a collection of
    :class:`nova.openstack.common.report.models.threading.GreenThreadModel`
    ...
    .. seealso::
        ...
        Function :func:`nova.openstack.common.report.utils._find_objects`
    """
